...
export interface ApiArticlePageArticlePage extends Schema.CollectionType {
  ...
  attributes: {
    article: Attribute.Component<'categories.ministries-category'>;
    link: Attribute.Component<'components.button'>;
    blog_2: Attribute.RichText;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiEpisodeEpisode extends Schema.CollectionType {
  ...
  attributes: {
    media: Attribute.Component<'episode.episode'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiSeriesDetailSeriesDetail extends Schema.CollectionType {
  ...
  attributes: {
    series: Attribute.Component<'series.series-detail'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::series-detail.series-detail',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::series-detail.series-detail': ApiSeriesDetailSeriesDetail;
    }
  }
}
